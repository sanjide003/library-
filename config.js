...
const i18n = {
    en: {
        ...
        adminPanelTitle: "Admin Controls", navAddBook: "Add New Book", navRegistry: "Books Registry", navBulk: "Bulk Import", navIssue: "Issue / Return", navUsers: "Users", navSettings: "Settings",
        ...
        settingsTitle: "Library Settings", settingsDesc: "Update global information, logos, and notifications.", notifyTitle: "Notifications & API Integration", notifyDesc: "Configure automatic SMS/WhatsApp messages via Twilio or Meta.", btnSaveSettings: "Save Settings",
    ...
    ml: {
        ...
        adminPanelTitle: "അഡ്മിൻ പാനൽ", navAddBook: "പുതിയ പുസ്തകം ചേർക്കുക", navRegistry: "രജിസ്റ്ററിലെ പുസ്തകങ്ങൾ", navBulk: "ബൾക്ക് ഇമ്പോർട്ട് (CSV)", navIssue: "ഇഷ്യൂ / റിട്ടേൺ", navUsers: "വായനക്കാർ (Users)", navSettings: "സെറ്റിംഗ്സ്",
        ...
        settingsTitle: "ലൈബ്രറി സെറ്റിംഗ്സ്", settingsDesc: "പൊതുവായ വിവരങ്ങൾ, ലോഗോ, നോട്ടിഫിക്കേഷനുകൾ എന്നിവ അപ്ഡേറ്റ് ചെയ്യുക.", notifyTitle: "നോട്ടിഫിക്കേഷൻ & API സെറ്റിംഗ്സ്", notifyDesc: "Twilio അല്ലെങ്കിൽ Meta വഴി ഓട്ടോമാറ്റിക് SMS/WhatsApp മെസ്സേജുകൾ ക്രമീകരിക്കുക.", btnSaveSettings: "സെറ്റിംഗ്സ് സേവ് ചെയ്യുക",
    ...
    ar: {
        ...
        adminPanelTitle: "لوحة الإدارة", navAddBook: "إضافة كتاب جديد", navRegistry: "سجل الكتب", navBulk: "استيراد جماعي", navIssue: "إعارة / إرجاع", navUsers: "المستخدمون", navSettings: "الإعدادات",
        ...
        settingsTitle: "إعدادات المكتبة", settingsDesc: "تحديث المعلومات العامة والشعارات والإشعارات.", notifyTitle: "الإشعارات وتكامل API", notifyDesc: "تكوين رسائل SMS/WhatsApp التلقائية عبر Twilio أو Meta.", btnSaveSettings: "حفظ الإعدادات",
